                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group @if($errors->has('thumbnail')) has-error @endif">
                            {!! Form::label('Ikonka') !!}
                            {!! Form::text('thumbnail', null, ['class' => 'form-control', 'placeholder' => 'Ikonka']) !!}
                        ...
                        <div class="form-group @if($errors->has('sub_title')) has-error @endif">
                            {!! Form::label('Podtytuł') !!}
                            {!! Form::text('sub_title', null, ['class' => 'form-control', 'placeholder' => 'Podtytuł']) !!}
                        ...
                        <div class="form-group @if($errors->has('details')) has-error @endif">
                            {!! Form::label('Treść') !!}
                            {!! Form::textarea('details', null, ['class' => 'form-control', 'placeholder' => 'Treść']) !!}
